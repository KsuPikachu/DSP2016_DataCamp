...
- 研究主題 (10 mins)
- 資料收集與整理(Homework) (10 mins)
- EDA by ggplot (暫時不帶入分群方法 60 mins)
    - 空間資料分析：ggmap => 用電量地圖 (demo 20 ~ 30 min)
    - 用電量與面積的關係 (demo 5 min)
    - 用電量與男女比例的關係 (do)
    - 用電量與老人比例的關係 (do)
    - 用電量與教育程度的關係 (do)
    - 用電量與所得的關係 (do)
...
- 設計Story Dashboard (以簡單的FlexDashboard做上手 40 mins)
    - 套件安裝
    - 基本介紹
    - 將剛剛的分析製作成Dashboard
...
<img src="img/eco.jpg" width="400px">


每到夏天，用電量的議題持續受到關注。對於供電情況，曾說過「兩年不缺電」的經濟部長李世光今[改口表示](https://video.udn.com/news/498892)，供電的確吃緊，經濟部、台電正全力以赴面對。對於今夏能否保證不跳電，李說：「全世界的工程沒有100%。」
...
- 空間資料分析 (地圖、密度圖)
- 雷達圖： 用電量高的里 vs 用電量低的里
- 互動式圖表： Plotly

分析結果呈現(Optional, FlexDashboard)：
